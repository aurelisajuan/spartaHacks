...
export default function Page() {
  ...
  // Simulate adding new transcript messages every 5 seconds
  useEffect(() => {
    const interval = setInterval(() => {
      setTranscript((prev) => [
        ...prev,
  ...
  return (
    <>
      ...
      {/* Overall container set to fill viewport height (min-h-screen) so the page doesn't scroll */}
      <div className="flex min-h-screen bg-[#F2F8F8] overflow-hidden">
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Content Area: Map on the left and Right Sidebar */}
          <div className="flex flex-1 overflow-hidden">
            {/* Map Area */}
            <div className="relative flex-1">
              <MapContainer
                center={[40.7128, -74.006]} // Update the center as needed
                zoom={13}
            ...
            {/* Right Sidebar (Store Info & Live Transcript) */}
            <div className="w-96 flex flex-col bg-white border-l border-[#55743B]/10">
              {/* Store Information */}
              <div className="p-4 border-b border-[#55743B]/10 overflow-auto">
                <h2 className="mb-4 text-lg font-semibold text-[#133223]">Store Information</h2>
                <div className="space-y-4">
                  {stores.map((store) => (
                    <Card
